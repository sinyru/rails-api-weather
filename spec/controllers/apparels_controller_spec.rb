...
RSpec.describe ApparelsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested apparel as @apparel" do
      apparel = Apparel.create! valid_attributes
      get :show, params: {id: apparel.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested apparel as @apparel" do
      apparel = Apparel.create! valid_attributes
      get :edit, params: {id: apparel.to_param}, session: valid_session
      expect(assigns(:apparel)).to eq(apparel)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Apparel" do
        expect {
          post :create, params: {apparel: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved apparel as @apparel" do
        post :create, params: {apparel: invalid_attributes}, session: valid_session
        expect(assigns(:apparel)).to be_a_new(Apparel)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested apparel" do
        apparel = Apparel.create! valid_attributes
        put :update, params: {id: apparel.to_param, apparel: new_attributes}, session: valid_session
        apparel.reload
      ...
      it "assigns the requested apparel as @apparel" do
        apparel = Apparel.create! valid_attributes
        put :update, params: {id: apparel.to_param, apparel: valid_attributes}, session: valid_session
        expect(assigns(:apparel)).to eq(apparel)
      end
    ...
    context "with invalid params" do
      it "assigns the apparel as @apparel" do
        apparel = Apparel.create! valid_attributes
        put :update, params: {id: apparel.to_param, apparel: invalid_attributes}, session: valid_session
        expect(assigns(:apparel)).to eq(apparel)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested apparel" do
      apparel = Apparel.create! valid_attributes
      expect {
        delete :destroy, params: {id: apparel.to_param}, session: valid_session
      }.to change(Apparel, :count).by(-1)
    end
